(function (){
  ...
  // GENERATED from dataset.yaml at Thu Aug  1 13:55:39 CEST 2019 by rchlodnicki

  // Snapshot from package.json
  var package_info = {"name":"woothee","version":"1.10.0","description":"User-Agent string parser (js implementation)","main":"./release/woothee","devDependencies":{"chai":">= 1.3.0","js-yaml":">= 1.0.3","mocha":"^6.0.0","serialize-to-js":"^3.0.0","should":"~1.2.2"},"scripts":{"test":"make test"},"repository":{"type":"git","url":"https://github.com/woothee/woothee-js"},"author":"tagomoris","license":"Apache-2.0"};
  ...
  (function(){
    ...
    // GENERATED from dataset.yaml at Thu Aug  1 13:55:38 CEST 2019 by rchlodnicki
